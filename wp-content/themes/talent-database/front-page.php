...
<body <?php body_class( 'd-flex flex-column align-items-stretch min-vh-100' ); ?>>
	...
	<header>
		<div class="container d-flex flex-column flex-md-row justify-content-between align-items-center py-3">
			<a href="<?php echo is_user_logged_in() ? esc_url( home_url( '/talent' ) ) : esc_url( home_url( '/' ) ); ?>" class="d-flex align-items-center mb-3 mb-md-0 gap-2 text-dark text-decoration-none">
				<img src="<?php echo esc_url( get_template_directory_uri() . '/img/the-great-seal-min.svg' ); ?>" alt="Choctaw Nation of Oklahoma" height="150" loading="eager" />
