 ...
 * Description: A basic bootstrap container with one row and one column.
 * Slug: cno/basic-container
 * Categories: cno/bootstrap-layouts
 * Viewport Width: 1320
 *
...
<section class="wp-block-group container">
	<!-- wp:group {"metadata":{"name":"Row"},"className":"row row-cols-1 row-cols-lg-2 flex-row-reverse","layout":{"type":"constrained"}} -->
	<div class="wp-block-group row">
		<!-- wp:group {"metadata":{"name":"Col"},"className":"col","layout":{"type":"constrained"}} -->
		<div class="wp-block-group col">
			<!-- wp:heading -->
			<h2 class="wp-block-heading">An H2 Element</h2>
			<!-- /wp:heading -->
